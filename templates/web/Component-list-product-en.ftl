...
<section class="section sec-pageTitle style-2 style-blogDetail">
    <div class="sec-pageTitle__wrap">
        <ul class="sec-pageTitle__breadcrumb">
            ...
            <li><span>Product-Service</span></li>
        </ul>
...
<section class="section sec-productBox">
    <div class="container-custom">
        <div class="productbox-list">
            <#-- Kiểm tra có sản phẩm để hiển thị không -->
                            ...
                            <div class="productbox__inner">
                                <div class="group">
                                    ...
                                    <h3 class="productbox__title">
                                        <a href="${product.url_en!''}">${product.title_en!''}</a>
                                    </h3>
                                </div>
                                <div class="productbox__btn">
                                    <a href="${product.url_en!''}" class="btn-text">
            ...
            <#if totalPages?? && (totalPages > 1)>
                <div class="pagination">
                    <nav class="navigation pagination" aria-label="Product pagination">
                        <h2 class="screen-reader-text">Product pagination</h2>
                        <div class="nav-links">
                            <#-- Nút Previous -->
            ...
            <#if totalItems?? && (totalItems > 0)>
                <div class="pagination-info text-center mt-3">
                    ...
                    <p>Showing ${fromItem} - ${toItem} of ${totalItems!0} products</p>
                </div>
            </#if>
        </div>
    </div>
